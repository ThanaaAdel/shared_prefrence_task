...
class AppColors {
  ...
  static Color grayTextColor = HexColor('#777777');
  ...
  static Color liveExamColor = HexColor('#FFEAD7');
  ...
  static Color lightBlue = HexColor('#00B3DC');
